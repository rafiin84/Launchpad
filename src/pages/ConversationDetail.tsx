...
export default function ConversationDetail() {
  ...
  if (!conversation) {
    return (
      <div className="max-w-2xl px-4 sm:px-6 pt-3 sm:pt-4 pb-6 sm:pb-8 animate-pulse space-y-4">
  ...
  return (
    <div className="max-w-2xl px-4 sm:px-6 pt-3 sm:pt-4 pb-6 sm:pb-8">
      <Link to="/conversations" className="md:hidden flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-900 mb-6 transition-colors">
        <ArrowLeft size={16} />
        All Conversations
      </Link>
